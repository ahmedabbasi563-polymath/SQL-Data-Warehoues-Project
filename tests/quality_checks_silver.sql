...
Script Purpose;
	...
	- NULL or duplicates primary key.
	- Unwanted spaces in string fields.
	- Data Standardization & Consistency.
	- Invalid date ranges and orders.
	- Data consistnecy between related fields
...
-- Check for wanted spaces
-- Execptation: No Result
SELECT
	prd_nm
FROM silver.crm_prd_info
...
-- Expections: Birthdates between 1924-01-01 and Today.
SELECT DISTINCT
	bdate
